...
import random
import time
from agent.UTIL.colorful import *
"""
...
class NewAgent(Agent):
    ...
    # Stack:
    # step (.\agent\demo_agent.py:126)
    # _agent_step (.\env\env_runner.py:102)
    # get_action (.\env\env_runner.py:85)
    # run_env (.\run.py:144)
    # run (.\run.py:59)
    # main_signal (.\run.py:153)
    # <module> (.\run.py:199)
        ...
        [ print(my_entity_infos)
            {
                ...
                'Type': 1, 
                'Availability': 1.0, 
                'X': -133398.82102700585, 
                'Y': 4596.799950909112,
                'Lon': 1.9854773578521967, 
                'Lat': 0.2624612800040167, 
                'Alt': 9000.016289889812, 
                'Heading': 1.9301988341714331, 
                'Pitch': 2.2091852664864e-05, 
                'Roll': 0.07853981633974483, 
                'Speed': 301.36736500000046, 
                'CurTime': 2.0, 
                'AccMag': 9.80665, 
                'NormalG': 0.0, 
                'IsLocked': False, 
            ...
            }, 
            {
                ...
                'Type': 2, 
                'Availability': 1.0, 
                'X': -133064.88125615503, 
                'Y': 91621.97117928107, 
                'Lon': 1.9854500958833592, 
                'Lat': 0.27610167925134554, 
                'Alt': 9000.001132820733, 
                'Heading': 1.8171993790414682,
                'Pitch': 3.0842163893700696e-06, 
                'Roll': 0.0, 
                'Speed': 202.7347300000001, 
                'CurTime': 2.0, 
                'AccMag': 19.6133, 
                'NormalG': 0.0, 
                'IsLocked': False, 
            ...
            {'Name': '红无人机2', 'Identification': '红方', 'ID': 11, 'Type': 2, 'Availability': 1.0, 'X': -133313.9088124762, 'Y': 49112.442039334026, 'Lon': 1.9854499716725356, 'Lat': 0.26943845025966734, 'Alt': 9000.001132823527, 'Heading': 1.8171989179794819, 'Pitch': 3.0842158384635266e-06, 'Roll': 0.0, 'Speed': 202.7347299999999, 'CurTime': 2.0, 'AccMag': 19.6133, 'NormalG': 0.0, 'IsLocked': False, 'Status': 0, 'LeftWeapon': 2}, {'Name': '红无人机3', 'Identification': '红方', 'ID': 12, 'Type': 2, 'Availability': 1.0, 'X': -133746.85099461608, 'Y': -27347.768742620858, 'Lon': 1.9854497568258718, 'Lat': 0.25745422551713665, 'Alt': 9000.001132820733, 'Heading': 1.8171980929607647, 'Pitch': 3.0842164813867417e-06, 'Roll': 0.0, 'Speed': 202.7347299999999, 'CurTime': 2.0, 'AccMag': 19.613300000000002, 'NormalG': 0.0, 'IsLocked': False, 'Status': 0, 'LeftWeapon': 2}, {'Name': '红无人机4', 'Identification': '红方', 'ID': 13, 'Type': 2, 'Availability': 1.0, 'X': -133942.85300516317, 'Y': -63130.46789333177, 'Lon': 1.9854496600156086, 'Lat': 0.25184560823285457, 'Alt': 9000.001132820733, 'Heading': 1.8171977086520295, 'Pitch': 3.084216297596259e-06, 'Roll': 0.0, 'Speed': 202.73473000000007, 'CurTime': 2.0, 'AccMag': 19.6133, 'NormalG': 0.0, 'IsLocked': False, 'Status': 0, 'LeftWeapon': 2}]
        [
            {
                'Name': '蓝有人机', 
                'Identification': '蓝方', 
                ...
                'X': 131584.9053007015, 
                'Y': 4455.772820743202, 
                'Lon': 2.028485351343439, 
                'Lat': 0.26244075908379144, 
                'Alt': 9000.061715328135, 
                'Heading': -2.128372459943111, 
                'Pitch': 0.00013882348496583439, 
                'Roll': -0.7592182246175335, 
                'Speed': 291.5607150000004, 
                'CurTime': 3.0, 
                'IsLocked': False
            }, 
            {
                ...
                'Type': 2, 
                'Availability': 1.0, 
                'X': 131520.43050654576, 
                'Y': 91325.76888003429, 
                'Lon': 2.0285552537463443, 
                'Lat': 0.2760566007586868, 
                'Alt': 9000.029915613122, 
                'Heading': 3.1170417955870913, 
                'Pitch': 9.308307668218103e-05, 
                'Roll': -0.6021385919380436, 
                'Speed': 200.00000000000009, 
                'CurTime': 3.0, 
                'IsLocked': False
            }, 
            {'Name': '蓝无人机2', 'Identification': '蓝方', 'ID': 15, 'Type': 2, 'Availability': 1.0, 'X': 131766.53977563765, 'Y': 48816.20234866304, 'Lon': 2.0285553789184214, 'Lat': 0.26939337176724354, 'Alt': 9000.029915614985, 'Heading': 3.117042260291995, 'Pitch': 9.30830766567014e-05, 'Roll': -0.6021385919380436, 'Speed': 199.99999999999991, 'CurTime': 3.0, 'IsLocked': False}, {'Name': '蓝无人机3', 'Identification': '蓝方', 'ID': 16, 'Type': 2, 'Availability': 1.0, 'X': 132194.4058605322, 'Y': -27644.042581351587, 'Lon': 2.0285555954266554, 'Lat': 0.2574091470251336, 'Alt': 9000.02991561871, 'Heading': 3.1170430918304683, 'Pitch': 9.308307660488176e-05, 'Roll': -0.6021385919380436, 'Speed': 200.00000000000003, 'CurTime': 3.0, 'IsLocked': False}, {'Name': '蓝无人机4', 'Identification': '蓝方', 'ID': 17, 'Type': 2, 'Availability': 1.0, 'X': 132388.10864426248, 'Y': -63426.74309628114, 'Lon': 2.028555692985117, 'Lat': 0.2518005297410475, 'Alt': 9000.029915613122, 'Heading': 3.117043479176273, 'Pitch': 9.308307671318399e-05, 'Roll': -0.6021385919380436, 'Speed': 199.99999999999991, 'CurTime': 3.0, 'IsLocked': False}]
    ...
    def init_pos(self, cmd_list):
        ...
        if self.name == "red":
            leader_original_pos = {"X": -125000, "Y": -0, "Z": 9500}
        else :
            leader_original_pos = {"X": 125000, "Y": 0, "Z": 9500}
    ...
    def process_attack(self, sim_time, cmd_list):
        ...
        for plane_info in self.my_allplane_infos:  # 遍历所有的己方飞机，选择离己方最近距离的飞机进行攻击
            ...
            if close_target['close_distance'] <= 80000: #当最近的目标离己方飞机的间距小于60000时
                ...
                print红('make_attackparam(',plane_info['ID'],close_target['enemy_data']['ID'],'1)')
