...
class XSimManager(object):
    def __init__(self, time_ratio: int, image_name: str = '*******/bvrsim:trim'):
    ...
    def __start_env(self):
        ...
        # 'docker run --rm --net host -p 40255:40255 -itd --name xsim_40255 -w /home/x64 *******/bvrsim:trim python daemon_server.py 100 40255 40255  0'
        # 'docker run --rm --net host -p 47191:47191 -itd --name xsim_47191 -w /home/x64 *******/bvrsim:trim python daemon_server.py 100 47191 47191  0'
        docker_run = "docker run --rm -p {}:{} -itd --name {} -w /home/x64 {} python daemon_server.py {} {} {} {}"\
...
# def shut_down()
#     import subprocess
#     subprocess.Popen(open('TEMP/close_container'))
