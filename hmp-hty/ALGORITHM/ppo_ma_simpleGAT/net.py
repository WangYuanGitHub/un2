...
class Net(nn.Module):
    def __init__(self, rawob_dim, n_action, **kwargs):
        ...
        # E_GAT参数
        add_elu = AlgorithmConfig.add_elu
        add_self = AlgorithmConfig.add_self
        self.ct_GAT_layer = E_GAT(input_dim=h_dim,hidden_dim=h_dim,add_elu=add_elu,add_self=add_self)
