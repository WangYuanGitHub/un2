...
class Net(nn.Module):
    ...
    def _act(self, obs=None, obs_last=None, action_code=None, gru_cell_memory=None, test_mode=None, eval_mode=False, eval_actions=None, avail_act=None, agent_ids=None, eprsn=None):
        ...
        if not eval_mode: return act, value, actLogProbs, gru_cell_output, obs_last_output
        else:             return value, actLogProbs, distEntropy, probs, others, gru_cell_output, obs_last_output
