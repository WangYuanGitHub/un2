...
class Net(nn.Module):
    def __init__(self, rawob_dim, n_action, **kwargs):
        ...
        self.policy_head = nn.Sequential(
            nn.Linear(_size, h_dim*2), nn.ReLU(inplace=True),
            nn.Linear(h_dim*2, h_dim*2), nn.ReLU(inplace=True),
    ...
    def _act(self, obs=None, action_code=None, gru_cell_memory=None, test_mode=None, eval_mode=False, eval_actions=None, avail_act=None, agent_ids=None, eprsn=None):
        ...
        # # # # # # # # # # actor-critic share # # # # # # # # # # # #
        baec = self.obs_encoder(obs) # [B,N,1+n+n,C]
        ...
        gru_input = self.GRU_encoder(tmp)
