...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    :param remove_time_limit_termination: Remove terminations (dones) that are due to time limit.
        See https://*******.com/hill-a/stable-baselines/issues/863
    ...
    def _setup_learn(
        ...
        # see https://*******.com/DLR-RM/stable-baselines3/issues/46
        truncate_last_traj = (
    ...
    def collect_rollouts(
        ...
        while should_collect_more_steps(train_freq, num_collected_steps, num_collected_episodes):
            ...
            while not done:
                ...
                # see https://*******.com/hill-a/stable-baselines/issues/900
                # self._on_step()
            ...
            if done:
                ...
                if action_noise is not None: action_noise.reset()
