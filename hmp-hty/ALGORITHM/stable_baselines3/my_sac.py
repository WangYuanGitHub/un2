...
class SAC():
    ...
    def _setup_model(self) -> None:
        ...
        if isinstance(self.ent_coef, str) and self.ent_coef.startswith("auto"):
            ...
            # Note: we optimize the log of the entropy coeff which is slightly different from the paper as discussed in https://*******.com/rail-berkeley/softlearning/issues/37
