...
class TrajPoolSampler():
    def __init__(self, n_div, traj_pool, flag, prevent_batchsize_oom=False, mcv=None):
        ...
        self.warned = False
        assert flag=='train'
        req_dict =        ['avail_act', 'obs', 'action', 'actionLogProb', 'action_code', 'gru_cell_memory', 'return', 'reward', 'value','type_label']
        req_dict_rename = ['avail_act', 'obs', 'action', 'actionLogProb', 'action_code', 'gru_cell_memory', 'return', 'reward', 'state_value','type_label']
