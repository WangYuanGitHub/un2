...
class MultiHeadAttention(nn.Module):
    # taken from https://*******.com/wouterkool/attention-tsp/blob/master/graph_encoder.py
    def __init__(
            self,
            n_heads,
            input_dim,
...
class SingleHeadSelfAttention(nn.Module):
    def __init__(self, input_dim, h_dim):
        super().__init__()
        self.W_query = nn.Parameter(torch.Tensor(input_dim, h_dim))
        self.W_key = nn.Parameter(torch.Tensor(input_dim, h_dim))
        self.W_val = nn.Parameter(torch.Tensor(input_dim, h_dim))
        self.init_parameters()
