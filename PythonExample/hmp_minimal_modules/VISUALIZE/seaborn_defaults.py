...
def save_and_push(handle, img_path, check_exist=True):
    ...
    subprocess.Popen([
        'curl', '-T', img_path, '-u', '*******:clara', 
        'http://cloud.*******.top:4080/remote.php/dav/files/*******/research2/heteGrouping/img/%s'%image_basename
    ])
''' ratio problem 1
...
# curl -T ./imgsave/ADCA-Two-Phase.pdf -u *******:clara http://cloud.*******.top:4080/remote.php/dav/files/*******/research/paper03_phase3/DoR-LMAS/img/ADCA-Two-Phase.pdf
